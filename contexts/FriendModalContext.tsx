...
const FriendModalContext = createContext<FriendModalContextValue | undefined>(
	undefined
)

export const FriendModalProvider: React.FC<{ children: React.ReactNode }> = ({
	children,
}) => {
...
export const useFriendModal = () => {
	...
	if (!ctx)
		throw new Error(
			'useFriendModal must be used within FriendModalProvider'
		)
	return ctx
}
